...
export class ListMarcaComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.marcaForm = new FormGroup({
      marc_Marca: new FormControl("", Validators.required),
    });
   ...
   onSubmit() {
    ...
    this.marcaForm = new FormGroup({
      marc_Marca: new FormControl("", Validators.required),
         ...
         this.viewModel.Marc_Id = this.id ;
   ...
   Fill(id) {
       this.service.getFill(id).subscribe({
           next: (data: Fill) => {
            ...
            this.marcaForm = new FormGroup({
              marc_Marca: new FormControl(data.marc_Marca, Validators.required),
            });
        
               this.id = data.marc_Id;
               this.Collapse= true;
               this.DataTable = false;
               this.Agregar = false;
